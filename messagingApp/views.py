...
def upload_direct(request, user_id):
    ...
    payload = {
        ...
        'sender_has_photo': bool(msg.sender.profile_photo),
        'sender_photo_url': msg.sender.profile_photo.url if msg.sender.profile_photo else None,
        'content': msg.content,
...
def upload_group(request, group_id):
    ...
    payload = {
        ...
        'sender_has_photo': bool(gm.sender.profile_photo),
        'sender_photo_url': gm.sender.profile_photo.url if gm.sender.profile_photo else None,
        'content': gm.content,
